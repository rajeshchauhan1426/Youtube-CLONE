export const SearchBar = () => {
    return (
        <div className="w-full sm:w-2/4"> {/* Change width based on screen size */}
            <form>
                <div className="w-full sm:w-96 flex text-gray-900 border border-gray-500 rounded-3xl p-1 pl-3 text-sm pr-2"> {/* Change width based on screen size */}
